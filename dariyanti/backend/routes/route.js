...
import { authMiddleware, adminOnly} from "../src/middleware/authMiddleware.js";
...
router.post("/room", authMiddleware, adminOnly, createRoom);
router.put("/room/:id", authMiddleware, updateRoom);
router.patch("/room/:id/status", authMiddleware, updateRoomStatus);
router.delete("/room/:id", authMiddleware, adminOnly, deleteRoom);

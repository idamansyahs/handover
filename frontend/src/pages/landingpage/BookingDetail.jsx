  ...
  // Fungsi untuk memproses pembayaran
    const processPayment = async () => {
        ...
        try {
          ...
          onSuccess: function (result) {
            ...
            onClose: function () {
                ...
                setMessage({ text: "Anda menutup jendela pembayaran. Selesaikan pembayaran sebelum waktu habis atau batalkan pesanan secara manual.", type: 'info' });
                setIsPaying(false);
            }
        });
      } else {
      throw new Error("Token transaksi tidak valid.");
            ...
            setMessage({ text: 'Gagal memulai sesi pembayaran. Silakan coba lagi atau refresh halaman.', type: 'error' });
            setIsPaying(false);

...
const PaymentStatusBadge = ({ status }) => {
  ...
  switch (displayStatus) {
    case "PAID":
    case "SETTLEMENT":
    case "SUCCESS": // <-- PERBAIKAN: TAMBAHKAN "SUCCESS" DI SINI
      color = "success";
      text = "white";
      break;
    case "PENDING":
                  ...
                  <table className="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                      {bookings.length > 0 ? bookings.map((b) => (
                        ...
                        <tr>
                            {/* 🔹 Colspan diubah ke 13 */}
                            <td colSpan="13" className="text-center text-muted p-4">No bookings found.</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
